/*
 *  serial_amiga.cpp - Serial device driver, Amiga specific stuff
 *
...
int16 ASERDPort::control(uint32 pb, uint32 dce, uint16 code)
{
	...
	switch (code) {
		...
		case kSERDAssertRTS:
		case kSERDNegateRTS:
			return noErr;	// Not supported under Amiga
...
/*
 *  Convert Amiga error code to MacOS error code, set serdtResult and cum_errors
 */
