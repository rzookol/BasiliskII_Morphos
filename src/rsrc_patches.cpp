...
/*
 *  Install SynchIdleTime() patch.  This is deliberately conditional so a
 *  manually disabled idlewait preference leaves guest code untouched.
 */

static void patch_idle_time(uint8 *p, uint32 size, int n)
{
...
#error System specific handling for writable ROM is required here
		...
		// Patch SynchIdleTime() used by later System versions.
