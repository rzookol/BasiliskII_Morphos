/*
 *  user_strings_amiga.cpp - Amiga-specific localizable strings
 *
...
user_string_def platform_strings[] = {
	...
	{STR_VOLUME_IS_MOUNTED_WARN, "The volume '%s' is mounted under Amiga. Basilisk II will try to unmount it."},
